...
I configured a secured remote virtual machine to host a database server, and web applications which are data driven. This was accomplished through a provided Linux distribution by [Udacity](https://www.udacity.com), and an installed Apache2 server to serve Python Flask application that connects to PostgresSQL database.
...
## Summary of steps made to completion:
